...
clim.wyr %>%
  ...
  geom_point() +
  geom_hline(yint=sim.wyr[i_wyr, 'PRCP'], linetype=2, color='red') +
...
#   thresh2[m] <- quantile(PRCP_CURRENT[x],(thresh2_quantile))[[1]]
# }
...
```{r plot mc p, fig.width=10, fig.height=8}
...
# filter(current.sel, MONTH==sim.da[i, 'MONTH']) %>% summary
# 
