...
The code in this package is based on the original scripts written by Scott Steinschneider.
...
This figure shows the cumulative distribution frequency of each timeseries. Note that the x-axis has been truncated to a maximum of 60 mm/yr in order to show the lower part of the distribution.
