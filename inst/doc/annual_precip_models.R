...
## ----wgen plot mc summary, fig.height=8----------------------------------
par(mfrow=c(2,2))
x1 <- 1
...
lines(wgen_wave$period, sim.warm.gws.stat[x1:x2, 'MEAN'], lty=2, col="blue")
